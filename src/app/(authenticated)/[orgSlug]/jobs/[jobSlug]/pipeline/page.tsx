...
import { AtsJobPipelinePageShell } from '@/modules/candidates/components/AtsJobPipelinePageShell';
...
export default async function JobPipelinePage({
  ...
  return <AtsJobPipelinePageShell orgSlug={orgSlug} memberId={member.id} jobSlug={jobSlug} />;
}
