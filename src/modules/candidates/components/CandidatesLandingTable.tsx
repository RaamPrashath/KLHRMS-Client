              ...
              <TableHeader className="bg-canvas/50">
                {table.getHeaderGroups().map((hg) => (
                  <TableRow key={hg.id} className="border-black/[0.04] hover:bg-transparent">
                    ...
                    <TableHead className="w-[6%] py-3 pr-6 pl-3" />
                  </TableRow>
                ))}
              </TableHeader>
                        ...
                        <div className="flex justify-end">
                          <button
                            ...
                            onClick={(event) => {
                              ...
                              router.push(`/${orgSlug}/candidates/${row.original.slug}`);
                            }}
                            className="inline-flex h-9 items-center justify-center rounded-lg px-3 text-neutral-700 hover:bg-black/5"
                          >
